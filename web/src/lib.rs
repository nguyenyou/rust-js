...
//! from W3C's WebIDL (`@webref/idl` 3.84.0; specs: dom, html, uievents, pointerevents, cssom, cssom-view, geometry, fetch, encoding). Do not edit.
//!
...
pub mod html_input_element {
    ...
    unsafe extern "Rust" {
        ...
        /// [MDN](https://developer.mozilla.org/docs/Web/API/HTMLInputElement/setRangeText)
        #[link_name = "setRangeText"]
        pub safe fn set_range_text_with_selection_mode(this: &HtmlInputElement, replacement: &str, start: u32, end: u32, selection_mode: &str);
...
pub mod html_text_area_element {
    ...
    unsafe extern "Rust" {
        ...
        /// [MDN](https://developer.mozilla.org/docs/Web/API/HTMLTextAreaElement/setRangeText)
        #[link_name = "setRangeText"]
        pub safe fn set_range_text_with_selection_mode(this: &HtmlTextAreaElement, replacement: &str, start: u32, end: u32, selection_mode: &str);
