...
//! from W3C's WebIDL (`@webref/idl` 3.84.0; specs: dom, html, uievents, pointerevents, cssom, cssom-view, geometry, fetch, encoding, wasm-js-api, wasm-web-api, xhr, streams, touch-events). Do not edit.
//!
...
pub mod event_target {
    ...
    unsafe extern "Rust" {
        ...
        /// [MDN](https://developer.mozilla.org/docs/Web/API/EventTarget/addEventListener)
        #[link_name = "addEventListener"]
        pub safe fn add_event_listener_with_bool(this: &EventTarget, type_: &str, callback: Box<dyn FnMut(&Event)>, options: bool);
        ...
        /// [MDN](https://developer.mozilla.org/docs/Web/API/EventTarget/removeEventListener)
        #[link_name = "removeEventListener"]
        pub safe fn remove_event_listener_with_bool(this: &EventTarget, type_: &str, callback: Box<dyn FnMut(&Event)>, options: bool);
...
pub mod node {
    ...
    unsafe extern "Rust" {
        ...
        /// [MDN](https://developer.mozilla.org/docs/Web/API/Node/cloneNode)
        #[link_name = "cloneNode"]
        pub safe fn clone_node_with_subtree(this: &Node, subtree: bool) -> &'static Node;
...
pub mod text {
    ...
    unsafe extern "Rust" {
        ...
        /// [MDN](https://developer.mozilla.org/docs/Web/API/Text/Text)
        #[link_name = "new Text"]
        pub safe fn new_with_data(data: &str) -> &'static Text;
...
pub mod comment {
    ...
    unsafe extern "Rust" {
        ...
        /// [MDN](https://developer.mozilla.org/docs/Web/API/Comment/Comment)
        #[link_name = "new Comment"]
        pub safe fn new_with_data(data: &str) -> &'static Comment;
...
pub mod element {
    ...
    unsafe extern "Rust" {
        ...
        /// [MDN](https://developer.mozilla.org/docs/Web/API/Element/toggleAttribute)
        #[link_name = "toggleAttribute"]
        pub safe fn toggle_attribute_with_force(this: &Element, qualified_name: &str, force: bool) -> bool;
        ...
        /// [MDN](https://developer.mozilla.org/docs/Web/API/Element/scrollIntoView)
        #[link_name = "scrollIntoView"]
        pub safe fn scroll_into_view_with_bool(this: &Element, arg: bool) -> Promise<()>;
        ...
        /// [MDN](https://developer.mozilla.org/docs/Web/API/Element/scroll)
        #[link_name = "scroll"]
        pub safe fn scroll_with_x_and_y(this: &Element, x: f64, y: f64) -> Promise<()>;
        ...
        /// [MDN](https://developer.mozilla.org/docs/Web/API/Element/scrollTo)
        #[link_name = "scrollTo"]
        pub safe fn scroll_to_with_x_and_y(this: &Element, x: f64, y: f64) -> Promise<()>;
        ...
        /// [MDN](https://developer.mozilla.org/docs/Web/API/Element/scrollBy)
        #[link_name = "scrollBy"]
        pub safe fn scroll_by_with_x_and_y(this: &Element, x: f64, y: f64) -> Promise<()>;
...
pub mod document {
    ...
    unsafe extern "Rust" {
        ...
        /// [MDN](https://developer.mozilla.org/docs/Web/API/Document/createElement)
        #[link_name = "createElement"]
        pub safe fn create_element_with_str(this: &Document, local_name: &str, options: &str) -> &'static Element;
        ...
        /// [MDN](https://developer.mozilla.org/docs/Web/API/Document/createElementNS)
        #[link_name = "createElementNS"]
        pub safe fn create_element_ns_with_str(this: &Document, namespace: &str, qualified_name: &str, options: &str) -> &'static Element;
        ...
        /// [MDN](https://developer.mozilla.org/docs/Web/API/Document/importNode)
        #[link_name = "importNode"]
        pub safe fn import_node_with_bool(this: &Document, node: &Node, options: bool) -> &'static Node;
        ...
        /// [MDN](https://developer.mozilla.org/docs/Web/API/Document/open)
        #[link_name = "open"]
        pub safe fn open_with_unused1(this: &Document, unused1: &str) -> &'static Document;

        /// [MDN](https://developer.mozilla.org/docs/Web/API/Document/open)
        #[link_name = "open"]
        pub safe fn open_with_unused1_and_unused2(this: &Document, unused1: &str, unused2: &str) -> &'static Document;
        ...
        /// [MDN](https://developer.mozilla.org/docs/Web/API/Document/execCommand)
        #[link_name = "execCommand"]
        pub safe fn exec_command_with_show_ui(this: &Document, command_id: &str, show_ui: bool) -> bool;

        /// [MDN](https://developer.mozilla.org/docs/Web/API/Document/execCommand)
        #[link_name = "execCommand"]
        pub safe fn exec_command_with_show_ui_and_value(this: &Document, command_id: &str, show_ui: bool, value: &str) -> bool;
...
pub mod abort_controller {
    ...
    unsafe extern "Rust" {
        /// [MDN](https://developer.mozilla.org/docs/Web/API/AbortController/AbortController)
        #[link_name = "new AbortController"]
        pub safe fn new() -> &'static AbortController;

        /// [MDN](https://developer.mozilla.org/docs/Web/API/AbortController/signal)
        #[link_name = "get signal"]
        pub safe fn signal(this: &AbortController) -> &'static AbortSignal;
...
pub mod html_select_element {
    ...
    unsafe extern "Rust" {
        ...
        /// [MDN](https://developer.mozilla.org/docs/Web/API/HTMLSelectElement/add)
        #[link_name = "add"]
        pub safe fn add_with_html_element(this: &HtmlSelectElement, element: &HtmlOptionElement, before: &HtmlElement);

        /// [MDN](https://developer.mozilla.org/docs/Web/API/HTMLSelectElement/add)
        #[link_name = "add"]
        pub safe fn add_with_i32(this: &HtmlSelectElement, element: &HtmlOptionElement, before: i32);
...
pub mod window {
    ...
    unsafe extern "Rust" {
        ...
        /// [MDN](https://developer.mozilla.org/docs/Web/API/Window/alert)
        #[link_name = "alert"]
        pub safe fn alert_with_message(this: &Window, message: &str);
        ...
        /// [MDN](https://developer.mozilla.org/docs/Web/API/Window/scroll)
        #[link_name = "scroll"]
        pub safe fn scroll_with_x_and_y(this: &Window, x: f64, y: f64) -> Promise<()>;
        ...
        /// [MDN](https://developer.mozilla.org/docs/Web/API/Window/scrollTo)
        #[link_name = "scrollTo"]
        pub safe fn scroll_to_with_x_and_y(this: &Window, x: f64, y: f64) -> Promise<()>;
        ...
        /// [MDN](https://developer.mozilla.org/docs/Web/API/Window/scrollBy)
        #[link_name = "scrollBy"]
        pub safe fn scroll_by_with_x_and_y(this: &Window, x: f64, y: f64) -> Promise<()>;
        ...
        /// [MDN](https://developer.mozilla.org/docs/Web/API/Window/setTimeout)
        #[link_name = "setTimeout"]
        pub safe fn set_timeout(this: &Window, handler: &str) -> i32;

        /// [MDN](https://developer.mozilla.org/docs/Web/API/Window/setTimeout)
        #[link_name = "setTimeout"]
        pub safe fn set_timeout_with_timeout(this: &Window, handler: &str, timeout: i32) -> i32;
        ...
        /// [MDN](https://developer.mozilla.org/docs/Web/API/Window/clearTimeout)
        #[link_name = "clearTimeout"]
        pub safe fn clear_timeout_with_id(this: &Window, id: i32);

        /// [MDN](https://developer.mozilla.org/docs/Web/API/Window/setInterval)
        #[link_name = "setInterval"]
        pub safe fn set_interval(this: &Window, handler: &str) -> i32;

        /// [MDN](https://developer.mozilla.org/docs/Web/API/Window/setInterval)
        #[link_name = "setInterval"]
        pub safe fn set_interval_with_timeout(this: &Window, handler: &str, timeout: i32) -> i32;
        ...
        /// [MDN](https://developer.mozilla.org/docs/Web/API/Window/clearInterval)
        #[link_name = "clearInterval"]
        pub safe fn clear_interval_with_id(this: &Window, id: i32);

        /// [MDN](https://developer.mozilla.org/docs/Web/API/Window/fetch)
        pub safe fn fetch(this: &Window, input: &Request) -> Promise<&'static Response>;

        /// [MDN](https://developer.mozilla.org/docs/Web/API/Window/fetch)
        #[link_name = "fetch"]
        pub safe fn fetch_with_str(this: &Window, input: &str) -> Promise<&'static Response>;
...
pub mod history {
    ...
    unsafe extern "Rust" {
        ...
        /// [MDN](https://developer.mozilla.org/docs/Web/API/History/go)
        #[link_name = "go"]
        pub safe fn go_with_delta(this: &History, delta: i32);
...
pub mod data_transfer {
    ...
    unsafe extern "Rust" {
        /// [MDN](https://developer.mozilla.org/docs/Web/API/DataTransfer/DataTransfer)
        #[link_name = "new DataTransfer"]
        pub safe fn new() -> &'static DataTransfer;

        /// [MDN](https://developer.mozilla.org/docs/Web/API/DataTransfer/dropEffect)
        #[link_name = "get dropEffect"]
        pub safe fn drop_effect(this: &DataTransfer) -> String;

        /// [MDN](https://developer.mozilla.org/docs/Web/API/DataTransfer/dropEffect)
        #[link_name = "set dropEffect"]
        pub safe fn set_drop_effect(this: &DataTransfer, value: &str);

        /// [MDN](https://developer.mozilla.org/docs/Web/API/DataTransfer/effectAllowed)
        #[link_name = "get effectAllowed"]
        pub safe fn effect_allowed(this: &DataTransfer) -> String;

        /// [MDN](https://developer.mozilla.org/docs/Web/API/DataTransfer/effectAllowed)
        #[link_name = "set effectAllowed"]
        pub safe fn set_effect_allowed(this: &DataTransfer, value: &str);

        /// [MDN](https://developer.mozilla.org/docs/Web/API/DataTransfer/setDragImage)
        ...
        /// [MDN](https://developer.mozilla.org/docs/Web/API/DataTransfer/setData)
        #[link_name = "setData"]
        pub safe fn set_data(this: &DataTransfer, format: &str, data: &str);

        /// [MDN](https://developer.mozilla.org/docs/Web/API/DataTransfer/clearData)
        #[link_name = "clearData"]
        pub safe fn clear_data(this: &DataTransfer);

        /// [MDN](https://developer.mozilla.org/docs/Web/API/DataTransfer/clearData)
        #[link_name = "clearData"]
        pub safe fn clear_data_with_format(this: &DataTransfer, format: &str);
    }
}
...
pub mod toggle_event {
    ...
    unsafe extern "Rust" {
        /// [MDN](https://developer.mozilla.org/docs/Web/API/ToggleEvent/ToggleEvent)
        #[link_name = "new ToggleEvent"]
        pub safe fn new(type_: &str) -> &'static ToggleEvent;
...
pub mod headers {
    ...
    unsafe extern "Rust" {
        ...
        pub safe fn new() -> &'static Headers;

        /// [MDN](https://developer.mozilla.org/docs/Web/API/Headers/append)
        pub safe fn append(this: &Headers, name: &str, value: &str);

        /// [MDN](https://developer.mozilla.org/docs/Web/API/Headers/delete)
...
pub mod request {
    ...
    unsafe extern "Rust" {
        ...
        pub safe fn new(input: &Request) -> &'static Request;

        /// [MDN](https://developer.mozilla.org/docs/Web/API/Request/Request)
        #[link_name = "new Request"]
        pub safe fn new_with_str(input: &str) -> &'static Request;

        /// [MDN](https://developer.mozilla.org/docs/Web/API/Request/method)
        #[link_name = "get method"]
        pub safe fn method(this: &Request) -> String;

        /// [MDN](https://developer.mozilla.org/docs/Web/API/Request/url)
        #[link_name = "get url"]
        pub safe fn url(this: &Request) -> String;

        /// [MDN](https://developer.mozilla.org/docs/Web/API/Request/headers)
        #[link_name = "get headers"]
        pub safe fn headers(this: &Request) -> &'static Headers;

        /// [MDN](https://developer.mozilla.org/docs/Web/API/Request/destination)
        #[link_name = "get destination"]
        pub safe fn destination(this: &Request) -> String;

        /// [MDN](https://developer.mozilla.org/docs/Web/API/Request/referrer)
        #[link_name = "get referrer"]
        pub safe fn referrer(this: &Request) -> String;

        /// [MDN](https://developer.mozilla.org/docs/Web/API/Request/referrerPolicy)
        #[link_name = "get referrerPolicy"]
        pub safe fn referrer_policy(this: &Request) -> String;

        /// [MDN](https://developer.mozilla.org/docs/Web/API/Request/mode)
        #[link_name = "get mode"]
        pub safe fn mode(this: &Request) -> String;

        /// [MDN](https://developer.mozilla.org/docs/Web/API/Request/credentials)
        #[link_name = "get credentials"]
        pub safe fn credentials(this: &Request) -> String;

        /// [MDN](https://developer.mozilla.org/docs/Web/API/Request/cache)
        #[link_name = "get cache"]
        pub safe fn cache(this: &Request) -> String;

        /// [MDN](https://developer.mozilla.org/docs/Web/API/Request/redirect)
        #[link_name = "get redirect"]
        pub safe fn redirect(this: &Request) -> String;

        /// [MDN](https://developer.mozilla.org/docs/Web/API/Request/integrity)
        #[link_name = "get integrity"]
        pub safe fn integrity(this: &Request) -> String;

        /// [MDN](https://developer.mozilla.org/docs/Web/API/Request/keepalive)
        #[link_name = "get keepalive"]
        pub safe fn keepalive(this: &Request) -> bool;

        /// [MDN](https://developer.mozilla.org/docs/Web/API/Request/isReloadNavigation)
        #[link_name = "get isReloadNavigation"]
        pub safe fn is_reload_navigation(this: &Request) -> bool;

        /// [MDN](https://developer.mozilla.org/docs/Web/API/Request/isHistoryNavigation)
        #[link_name = "get isHistoryNavigation"]
        pub safe fn is_history_navigation(this: &Request) -> bool;

        /// [MDN](https://developer.mozilla.org/docs/Web/API/Request/signal)
        #[link_name = "get signal"]
        pub safe fn signal(this: &Request) -> &'static AbortSignal;

        /// [MDN](https://developer.mozilla.org/docs/Web/API/Request/duplex)
        #[link_name = "get duplex"]
        pub safe fn duplex(this: &Request) -> String;

        /// [MDN](https://developer.mozilla.org/docs/Web/API/Request/clone)
        pub safe fn clone(this: &Request) -> &'static Request;

        /// [MDN](https://developer.mozilla.org/docs/Web/API/Request/body)
        #[link_name = "get body"]
        pub safe fn body(this: &Request) -> Option<&'static ReadableStream>;

        /// [MDN](https://developer.mozilla.org/docs/Web/API/Request/bodyUsed)
        ...
        /// [MDN](https://developer.mozilla.org/docs/Web/API/Request/formData)
        #[link_name = "formData"]
        ...
        /// [MDN](https://developer.mozilla.org/docs/Web/API/Request/textStream)
...
pub mod response {
    ...
    unsafe extern "Rust" {
        ...
        /// [MDN](https://developer.mozilla.org/docs/Web/API/Response/Response)
        #[link_name = "new Response"]
        pub safe fn new_with_readable_stream(body: &ReadableStream) -> &'static Response;

        /// [MDN](https://developer.mozilla.org/docs/Web/API/Response/Response)
        #[link_name = "new Response"]
        pub safe fn new_with_uint8_array(body: &Uint8Array) -> &'static Response;

        /// [MDN](https://developer.mozilla.org/docs/Web/API/Response/Response)
        #[link_name = "new Response"]
        pub safe fn new_with_array_buffer(body: &ArrayBuffer) -> &'static Response;

        /// [MDN](https://developer.mozilla.org/docs/Web/API/Response/Response)
        #[link_name = "new Response"]
        pub safe fn new_with_form_data(body: &FormData) -> &'static Response;

        /// [MDN](https://developer.mozilla.org/docs/Web/API/Response/Response)
        #[link_name = "new Response"]
        pub safe fn new_with_str(body: &str) -> &'static Response;

        /// [MDN](https://developer.mozilla.org/docs/Web/API/Response/type)
        #[link_name = "get type"]
        pub safe fn type_(this: &Response) -> String;

        /// [MDN](https://developer.mozilla.org/docs/Web/API/Response/url)
        #[link_name = "get url"]
        pub safe fn url(this: &Response) -> String;

        /// [MDN](https://developer.mozilla.org/docs/Web/API/Response/redirected)
        #[link_name = "get redirected"]
        pub safe fn redirected(this: &Response) -> bool;

        /// [MDN](https://developer.mozilla.org/docs/Web/API/Response/status)
        #[link_name = "get status"]
        pub safe fn status(this: &Response) -> u16;

        /// [MDN](https://developer.mozilla.org/docs/Web/API/Response/ok)
        #[link_name = "get ok"]
        pub safe fn ok(this: &Response) -> bool;

        /// [MDN](https://developer.mozilla.org/docs/Web/API/Response/statusText)
        #[link_name = "get statusText"]
        pub safe fn status_text(this: &Response) -> String;

        /// [MDN](https://developer.mozilla.org/docs/Web/API/Response/headers)
        #[link_name = "get headers"]
        pub safe fn headers(this: &Response) -> &'static Headers;

        /// [MDN](https://developer.mozilla.org/docs/Web/API/Response/clone)
        pub safe fn clone(this: &Response) -> &'static Response;

        /// [MDN](https://developer.mozilla.org/docs/Web/API/Response/body)
        #[link_name = "get body"]
        pub safe fn body(this: &Response) -> Option<&'static ReadableStream>;
...
pub mod form_data {
    ...
    unsafe extern "Rust" {
        ...
        pub safe fn new() -> &'static FormData;
        ...
        /// [MDN](https://developer.mozilla.org/docs/Web/API/FormData/delete)
        pub safe fn delete(this: &FormData, name: &str);

        /// [MDN](https://developer.mozilla.org/docs/Web/API/FormData/has)
        pub safe fn has(this: &FormData, name: &str) -> bool;

        /// [MDN](https://developer.mozilla.org/docs/Web/API/FormData/set)
        pub safe fn set(this: &FormData, name: &str, value: &str);
        ...
        pub safe fn get(this: &FormData, name: &str) -> Option<String>;

        /// [MDN](https://developer.mozilla.org/docs/Web/API/FormData/getAll): every text value of a field.
        #[link_name = "getAll"]
        pub safe fn get_all(this: &FormData, name: &str) -> Vec<String>;
    }
}
...
pub mod readable_stream {
    ...
    unsafe extern "Rust" {
        /// [MDN](https://developer.mozilla.org/docs/Web/API/ReadableStream/ReadableStream)
        #[link_name = "new ReadableStream"]
        pub safe fn new() -> &'static ReadableStream;

        /// [MDN](https://developer.mozilla.org/docs/Web/API/ReadableStream/ReadableStream)
        #[link_name = "new ReadableStream"]
        pub safe fn new_with_underlying_source(underlying_source: &dyn core::any::Any) -> &'static ReadableStream;

        /// [MDN](https://developer.mozilla.org/docs/Web/API/ReadableStream/locked)
        #[link_name = "get locked"]
        pub safe fn locked(this: &ReadableStream) -> bool;

        /// [MDN](https://developer.mozilla.org/docs/Web/API/ReadableStream/cancel)
        pub safe fn cancel(this: &ReadableStream) -> Promise<()>;
    }
}
...
pub mod touch {
    ...
    unsafe extern "Rust" {
        /// [MDN](https://developer.mozilla.org/docs/Web/API/Touch/identifier)
        #[link_name = "get identifier"]
        pub safe fn identifier(this: &Touch) -> i32;

        /// [MDN](https://developer.mozilla.org/docs/Web/API/Touch/target)
        #[link_name = "get target"]
        pub safe fn target(this: &Touch) -> &'static EventTarget;

        /// [MDN](https://developer.mozilla.org/docs/Web/API/Touch/screenX)
        #[link_name = "get screenX"]
        pub safe fn screen_x(this: &Touch) -> f64;

        /// [MDN](https://developer.mozilla.org/docs/Web/API/Touch/screenY)
        #[link_name = "get screenY"]
        pub safe fn screen_y(this: &Touch) -> f64;

        /// [MDN](https://developer.mozilla.org/docs/Web/API/Touch/clientX)
        #[link_name = "get clientX"]
        pub safe fn client_x(this: &Touch) -> f64;

        /// [MDN](https://developer.mozilla.org/docs/Web/API/Touch/clientY)
        #[link_name = "get clientY"]
        pub safe fn client_y(this: &Touch) -> f64;

        /// [MDN](https://developer.mozilla.org/docs/Web/API/Touch/pageX)
        #[link_name = "get pageX"]
        pub safe fn page_x(this: &Touch) -> f64;

        /// [MDN](https://developer.mozilla.org/docs/Web/API/Touch/pageY)
        #[link_name = "get pageY"]
...
pub mod touch_list {
    ...
    unsafe extern "Rust" {
        ...
        #[link_name = "get length"]
        pub safe fn length(this: &TouchList) -> u32;

        /// [MDN](https://developer.mozilla.org/docs/Web/API/TouchList/item)
        pub safe fn item(this: &TouchList, index: u32) -> Option<&'static Touch>;
    }
}
...
pub mod text_encoder {
    ...
    unsafe extern "Rust" {
        /// [MDN](https://developer.mozilla.org/docs/Web/API/TextEncoder/TextEncoder)
        #[link_name = "new TextEncoder"]
        pub safe fn new() -> &'static TextEncoder;

        /// [MDN](https://developer.mozilla.org/docs/Web/API/TextEncoder/encode)
        pub safe fn encode(this: &TextEncoder) -> &'static Uint8Array;
        ...
        #[link_name = "get encoding"]
        pub safe fn encoding(this: &TextEncoder) -> String;
    }
}
...
pub mod text_decoder {
    ...
    unsafe extern "Rust" {
        /// [MDN](https://developer.mozilla.org/docs/Web/API/TextDecoder/TextDecoder)
        #[link_name = "new TextDecoder"]
        pub safe fn new() -> &'static TextDecoder;

        /// [MDN](https://developer.mozilla.org/docs/Web/API/TextDecoder/TextDecoder)
        #[link_name = "new TextDecoder"]
        pub safe fn new_with_label(label: &str) -> &'static TextDecoder;
        ...
        /// [MDN](https://developer.mozilla.org/docs/Web/API/TextDecoder/decode)
        #[link_name = "decode"]
        pub safe fn decode_with_array_buffer(this: &TextDecoder, input: &ArrayBuffer) -> String;

        /// [MDN](https://developer.mozilla.org/docs/Web/API/TextDecoder/decode)
        #[link_name = "decode"]
        pub safe fn decode_with_uint8_array(this: &TextDecoder, input: &Uint8Array) -> String;

        /// [MDN](https://developer.mozilla.org/docs/Web/API/TextDecoder/encoding)
        #[link_name = "get encoding"]
        pub safe fn encoding(this: &TextDecoder) -> String;

        /// [MDN](https://developer.mozilla.org/docs/Web/API/TextDecoder/fatal)
        #[link_name = "get fatal"]
        pub safe fn fatal(this: &TextDecoder) -> bool;

        /// [MDN](https://developer.mozilla.org/docs/Web/API/TextDecoder/ignoreBOM)
...
pub mod web_assembly_module {
    ...
    unsafe extern "Rust" {
        ...
        pub safe fn new(bytes: &ArrayBuffer) -> &'static WebAssemblyModule;

        /// [MDN](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/WebAssembly/Module/Module)
        #[link_name = "new WebAssembly.Module"]
        pub safe fn new_with_uint8_array(bytes: &Uint8Array) -> &'static WebAssemblyModule;
    }
}
...
pub mod web_assembly_instance {
    ...
    unsafe extern "Rust" {
        /// [MDN](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/WebAssembly/Instance/Instance)
        #[link_name = "new WebAssembly.Instance"]
        pub safe fn new(module: &WebAssemblyModule) -> &'static WebAssemblyInstance;

        /// [MDN](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/WebAssembly/Instance/Instance)
        #[link_name = "new WebAssembly.Instance"]
        pub safe fn new_with_import_object(module: &WebAssemblyModule, import_object: &dyn core::any::Any) -> &'static WebAssemblyInstance;

        /// [MDN](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/WebAssembly/Instance/exports)
        #[link_name = "get exports"]
        pub safe fn exports(this: &WebAssemblyInstance) -> &'static JsObject;
    }
}
...
pub mod web_assembly_memory {
    ...
    unsafe extern "Rust" {
        /// [MDN](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/WebAssembly/Memory/toFixedLengthBuffer)
        #[link_name = "toFixedLengthBuffer"]
        pub safe fn to_fixed_length_buffer(this: &WebAssemblyMemory) -> &'static ArrayBuffer;

        /// [MDN](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/WebAssembly/Memory/toResizableBuffer)
        #[link_name = "toResizableBuffer"]
        pub safe fn to_resizable_buffer(this: &WebAssemblyMemory) -> &'static ArrayBuffer;
...
/// The [`WebAssembly`](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/WebAssembly) namespace.
...
pub mod web_assembly {
    ...
    unsafe extern "Rust" {
        ...
        pub safe fn validate(bytes: &ArrayBuffer) -> bool;

        /// [MDN](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/WebAssembly/validate)
        #[link_name = "WebAssembly.validate"]
        pub safe fn validate_with_uint8_array(bytes: &Uint8Array) -> bool;
        ...
        pub safe fn compile(bytes: &ArrayBuffer) -> Promise<&'static WebAssemblyModule>;

        /// [MDN](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/WebAssembly/compile)
        #[link_name = "WebAssembly.compile"]
        pub safe fn compile_with_uint8_array(bytes: &Uint8Array) -> Promise<&'static WebAssemblyModule>;
        ...
        pub safe fn instantiate(bytes: &ArrayBuffer) -> Promise<WebAssemblyInstantiatedSource>;

        /// [MDN](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/WebAssembly/instantiate)
        #[link_name = "WebAssembly.instantiate"]
        pub safe fn instantiate_with_uint8_array(bytes: &Uint8Array) -> Promise<WebAssemblyInstantiatedSource>;

        /// [MDN](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/WebAssembly/instantiate)
        #[link_name = "WebAssembly.instantiate"]
        pub safe fn instantiate_with_import_object(bytes: &ArrayBuffer, import_object: &dyn core::any::Any) -> Promise<WebAssemblyInstantiatedSource>;
        ...
        /// [MDN](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/WebAssembly/instantiate)
        #[link_name = "WebAssembly.instantiate"]
        pub safe fn instantiate_with_web_assembly_module_and_import_object(module_object: &WebAssemblyModule, import_object: &dyn core::any::Any) -> Promise<&'static WebAssemblyInstance>;

        /// [MDN](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/WebAssembly/compileStreaming)
        #[link_name = "WebAssembly.compileStreaming"]
        pub safe fn compile_streaming(source: Promise<&'static Response>) -> Promise<&'static WebAssemblyModule>;
        ...
        pub safe fn instantiate_streaming(source: Promise<&'static Response>) -> Promise<WebAssemblyInstantiatedSource>;

        /// [MDN](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/WebAssembly/instantiateStreaming)
        #[link_name = "WebAssembly.instantiateStreaming"]
        pub safe fn instantiate_streaming_with_import_object(source: Promise<&'static Response>, import_object: &dyn core::any::Any) -> Promise<WebAssemblyInstantiatedSource>;
    }
}
