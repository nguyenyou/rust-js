...
//! from W3C's WebIDL (`@webref/idl` 3.84.0; specs: dom, html, uievents, pointerevents, cssom, cssom-view, geometry, fetch, encoding, wasm-js-api, wasm-web-api). Do not edit.
//!
