...
`RefCell`, `Vec`, `HashMap`, `HashSet`, `BTreeMap` and `BTreeSet` with primitive keys ([ADR 0059](docs/decisions/0059-hashmap.md)), `VecDeque` and `BinaryHeap` ([ADR 0068](docs/decisions/0068-queues.md)), `for` loops over sequences and ranges, iterator chains, sorting, `usize`, `to_string()`;
